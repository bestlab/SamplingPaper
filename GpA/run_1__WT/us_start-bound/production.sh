...
qsubmit.py --topol topol.tpr --jobname "GpA_cg-together" --cluster biowulf2 --partition niddk --nodes 4 --script=submit.sh --duration 24:00:00
...
for i in {0..15}; do
	echo System | trjconv -pbc mol -f workdir__separate/traj${i}.xtc -dump 50e3 -s tpr/topol0.tpr -o conf/conf${i}.gro 
done
